window.onload = function() {
    var _price, _quantity, orderitem_num, delta_cost, delta_quantity, orderitem_quantity;
    var quantity_arr = [], price_arr = [];
...
// при использовании jquery.formset.js
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.price) {
                        ...
                        var current_tr = $('.order_form').find('.formset_row:eq(' + (orderitem_num)+ ')');
                        current_tr.find('.col:eq(2)').html(price_html);
                        if(current_tr.find('input[type="number"]').val() == "") {
